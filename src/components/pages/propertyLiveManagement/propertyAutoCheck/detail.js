...
import { Icon, Table, Form, Select, Button, AutoComplete, Input } from 'antd'
...
class Detail extends React.Component {
    ...
    this.state = {
      ...
      columns: [
...

        {
          ...
          width: 100,
          sorter: (a, b) => a.assetsName - b.assetsName,
        },
        {
          title: '占用U数',
  ...
  selectAll(param) {
    ...
    param? params=param:params={
      batchNum:this.props.batchNum,
      currentPage:0,
      pageSize:10
    }
    // api.Details_selectAll(params)
    // Axios.get('http://192.168.0.111:8062/assetsCheck/selectDetail',{params:params})
    api.Details_selectAll(params)
      .then(res => {
        console.log(res)
    ...
    return (
      <React.Fragment>
        ...
        <div style={{ position: "absolute", zIndex: 100, top: 80, background: '#f7f7f7', boxShadow: '0 0 10px #ececec', borderRadius: 6, padding: '5px', width: '45vw', height: '80vh' }}>
          ...
          <div style={{ fontFamily: 'aria', border: '2px #ebebeb solid', background: 'white', height: '69vh', overflow: 'hidden' }}>
            ...
            <Table bordered components={this.components}
              ...
              scroll={{ x: this.state.totalWidth + 200, y: 300 }}
